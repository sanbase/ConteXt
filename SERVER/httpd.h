...
#elif defined(__NetBSD__) || defined(__bsdi__)
#ifndef BSD
#define BSD
#endif
#undef NO_KILLPG
...
#define DEFAULT_CX_PATH "/usr/local/bin/cx5"
/* 
...
#define DEFAULT_XFERLOG "/var/log/httpd/access_log"
#define DEFAULT_ERRORLOG "/var/log/httpd/error_log"
...
#define RESOURCE_CONFIG_FILE "/var/www/conf/srm.conf"

/* The name of the MIME types file */
#define TYPES_CONFIG_FILE "/var/www/conf/mime.types"

/* The name of the access file */
#define ACCESS_CONFIG_FILE "/var/www/conf/access.conf"
...
#define DEFAULT_PATH "/usr/local/bin:/bin:/usr/bin:/usr/contrib/bin"
...
#define HUGE_STRING_LEN 81920

/* The timeout for waiting for messages */
#define DEFAULT_TIMEOUT 1200

/* The size of the server's internal read-write buffers */
#define IOBUFSIZE 81920
...
extern char cx_path[MAX_STRING_LEN];
...
/* http_get */
void send_file(char *file, FILE *fd, struct stat *fi,char *path_args, char *args);
...
void        log_pid();
void send_cgi(char *method, char *file, char *path_args, char *args,struct stat *finfo, int in, FILE *fd);
